  ...
  return (
    <View style={styles.cuerpo}>
      <View style={styles.cuadro}>
        <Text style={styles.texto}>Perfil de seguridad</Text>
      </View>
      ...
      <View style={styles.cuadro}>
        ...
        <View style={styles.separacion}>
          <TouchableOpacity style={styles.botones}>
            ...
            <Text style={styles.botones_texto}>Código de seguridad</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.separacion}>
          <TouchableOpacity style={styles.botones}>
            <Feather name="id-card" size={24} color="#33604E" style={styles.iconIzq} />
            <Text style={styles.botones_texto}>Identificación</Text>
          </TouchableOpacity>
        </View>

        <View style={styles.separacion}>
          <TouchableOpacity style={styles.botones}>
            <Feather name="phone" size={24} color="#33604E" style={styles.iconIzq} />
            <Text style={styles.botones_texto}>Número telefonico</Text>
          </TouchableOpacity>
        </View>

        <View style={styles.separacion}>
          <TouchableOpacity style={styles.botones}>
            <Feather name="mail" size={24} color="#33604E" style={styles.iconIzq} />
            <Text style={styles.botones_texto}>Correo de recuperación</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
